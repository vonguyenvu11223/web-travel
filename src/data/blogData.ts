const blogData = {
  title: "Travel Blog",
  sub_title: "Explore Asia and Europe",
  layout: "grid",
  data: [
    {
    ...
    },
    {
      ...
      description:
        "Paris in spring is a celebration of life, art, and romance. In this comprehensive article, we paint a vivid picture of Paris as it awakens from winter’s slumber, with its gardens bursting into bloom and streets filled with the gentle hum of café conversations. Journey through historic neighborhoods, admire the timeless architecture, and immerse yourself in the vibrant cultural scene that only Paris can offer. The narrative includes insider tips on the best local spots to enjoy the season’s charm, recommendations for quaint bistros, and a guide to must-see landmarks. This article not only serves as a travel guide but also as an ode to the city of lights, inviting you to experience Paris with all your senses.",
      ariaLabel: "Paris in Spring: A Dreamy Getaway",
      slug: "paris-in-spring-dreamy-getaway",
      image: {
        alt: "Yagi typhoon at Halong Bay",
        src: "https://res.cloudinary.com/drnf8u8vq/image/upload/c_fill,w_800/v1737802452/nextravel/blog/fuji_moutain_zlo1b3.jpg",
      },
      date: "2024-09-14T03:17:30.890Z",
    },
    {
    ...
    },
    {
      ...
      description:
        "The Swiss Alps offer a dramatic canvas of snow-dusted peaks, deep valleys, and charming mountain villages, all waiting to be explored. This extended article provides a panoramic view of what a winter adventure in the Alps truly entails. From adrenaline-pumping ski slopes and serene snowshoe trails to cozy alpine lodges where you can unwind with a hot cup of cocoa, every detail is captured in vivid description. The narrative not only highlights the natural beauty of the region but also delves into local traditions, the history of alpine sports, and insider travel tips to help you make the most of your adventure. Whether you are a seasoned skier or simply looking to experience the magic of a winter wonderland, this article is your comprehensive guide to the Swiss Alps.",
      ariaLabel: "Swiss Alps Adventure: A Winter Wonderland",
      slug: "swiss-alps-adventure-winter-wonderland",
      image: {
        alt: "Snow-covered mountains in the Swiss Alps",
        src: "https://res.cloudinary.com/drnf8u8vq/image/upload/c_fill,w_800/v1737802452/nextravel/blog/fuji_moutain_zlo1b3.jpg",
      },
      date: "2024-04-10T08:22:11.621Z",
    },
  ],
};
